...
public class DispatchServlet extends HttpServlet {
    ...
    private final String REMOVE_ITEM_FROM_YOUR_CART_CONTROLLER = "RemoveItemFromYourCartServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (button == null) {//first time and app start up
                //transfer Login page
                //check cookies to detemine which function is transfered
                ...
                url = REMOVE_ITEM_FROM_YOUR_CART_CONTROLLER;
